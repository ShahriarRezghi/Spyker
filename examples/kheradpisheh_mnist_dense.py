...
class Network:
    def __init__(self, device):
        ...
        self.conv1 = spyker.Conv(2, 32, 5, pad=2, mean=0.8, std=0.05, device=device)
        self.conv2 = spyker.Conv(32, 150, 2, pad=1, mean=0.8, std=0.05, device=device)
...
if __name__ == "__main__":
    batch_size = 64
    data_root = "./MNIST/"
    model_path = "kheradpisheh_mnist_dense.npz"
